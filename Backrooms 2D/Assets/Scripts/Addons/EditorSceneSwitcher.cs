//THANKS Scott Steffes! https://www.youtube.com/watch?v=_iEWvNyfkL0
#if UNITY_EDITOR
using System;
using UnityEditor;
...
namespace KingdomOfNight
{
    public partial class EditorSceneSwitcher
    {
        ...
        private const string PATH_TO_OUTPUT_SCRIPT_FILE = "/Scripts/EditorSceneSwitcherDropdowns.cs";
        ...
        public static void GenerateSceneLoadMenuCode()
        {
            ...
            void AddCodeForDirectory(DirectoryInfo directoryInfo, StringBuilder result)
            {
                ...
                void AddCodeForFile(FileInfo fileInfo, StringBuilder result)
                {
                    ...
                    result.Append("        public static void Load").Append(functionName).Append("() { EditorSceneSwitcher.OpenScene(\"").Append(assetPath).Append("\"); }").Append(Environment.NewLine); ;
                }
            }
        }
